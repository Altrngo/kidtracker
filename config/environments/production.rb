...
Rails.application.configure do
  ...
  # Replace the default in-process and non-durable queuing backend for Active Job. Disabled as solid queue is not used
  ...
  #
  config.hosts << "carbondsm-cal.synology.me"
